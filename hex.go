...
// Rounds a FractionalHex to a Regular HexCoord
func (h fractionalHex) Round() HexCoord {
...
func HexNeighbor(h HexCoord, direction direction) HexCoord {
...
func HexLineDraw(a, b HexCoord) []HexCoord {
...
func HexRectangleGrid(width, height int) []HexCoord {
...
func HexHasLineOfSight(center HexCoord, target HexCoord, blocking []HexCoord) bool {

	contains := func(s []HexCoord, e HexCoord) bool {
		for _, a := range s {
			if a == e {
				return true
			}
...
func HexFieldOfView(source HexCoord, candidates []HexCoord, blocking []HexCoord) []HexCoord {
